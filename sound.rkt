...
(define you-win (rs-scale MASTER-VOL (rs-append* (list (rs-overlay* (list (rs-scale 0.33
...
(define shuff-sound (rs-append* (list (lowpass 0.6 (make-noise 2205 (/ MASTER-VOL 16)))
                                      (make-tone (midi-note-num->pitch 92) MASTER-VOL 1000))))
